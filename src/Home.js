...
import my_profile_pic from './my_pic_.png';
import './App.css';
...
function Home() {
    return (
        <div>
            ...
            <a href="https://github.com/isajjad1246"
                target="_blank"
                rel="noopener noreferrer"
                className="github-link">
                {/* This IS the GitHub icon - same as FaGithub */}
                <svg 
                    width="80" 
                    height="80" 
                    viewBox="0 0 24 24" 
            ...
            <a href="https://www.linkedin.com/in/ifrah-sajjad-is/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <a href="mailto:isajjad1246@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className="mail-link">
                <svg 
